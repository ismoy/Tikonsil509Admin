...
class ListUsersAdapter(val context: Context) :
    RecyclerView.Adapter<ListUsersAdapter.MyViewHolder>() {
     var userregistrered = emptyList<Users>()


    @SuppressLint("NotifyDataSetChanged")
    fun setSaleListData(data: List<Users>) {
    ...
    class MyViewHolder(private val binding: ItemRegisteredUsersContentBinding) :
        ...
        fun bidView(usersdata: Users, context: Context) {
        ...
        private fun deleteUser(context: Context, usersdata: Users) {
 ...
 fun filterListUser(users: List<Users>){
     this.userregistrered = users
     notifyDataSetChanged()
 }
}